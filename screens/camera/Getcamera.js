...
import camerastyle from "./camerastyles";
import * as ImagePicker from "expo-image-picker";
export default function Getcamera({ navigation }) {
  ...
  return (
    <View style={camerastyle.container}>
      {image ? null : (
        <View style={camerastyle.cameracontaner}>
          <Camera
      ...
      {image && <Image style={camerastyle.image} source={{ uri: image }} />}
      {image ? null : (
        <>
          <View style={camerastyle.button_btn}>
            <Button
              title={flip}
              onPress={() => {
                setType(
